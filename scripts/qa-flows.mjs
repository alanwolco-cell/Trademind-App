...
check('fz26 premium: named constants calibrated', sandbox.FZ26_RB_PREM_ELITE === 1.18 && sandbox.FZ26_RB_PREM === 1.10 && sandbox.FZ26_BID_CAP === 1.25);
...
check('fz26 premium: bot max lands at ~1.18x, under the 1.25x cap', mx >= Math.round(63 * 1.12) && mx <= Math.round(63 * 1.25), '$' + mx);
